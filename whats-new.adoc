...
=== Cloud Volumes ONTAP 라이센스 관리

이제 홈 페이지 또는 *Direct licenses* 탭을 통해 Cloud Volumes ONTAP 라이센스를 관리할 수 있습니다. *Marketplace subscriptions* 탭을 사용하여 구독 정보를 확인하십시오.
...
https://docs.netapp.com/us-en/console-setup-admin/task-monitor-cm-operations.html["이메일 알림을 설정하는 방법을 알아보세요"^]
...
이제 Digital Wallet에서 계정의 총 사용 용량과 라이선스 패키지별 사용 용량을 확인할 수 있습니다. 이를 통해 요금 청구 방식을 파악하고 추가 용량 구매가 필요한지 여부를 판단할 수 있습니다.
