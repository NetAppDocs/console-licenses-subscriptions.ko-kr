...
summary: NetApp Console 에서 Cloud Volumes ONTAP 과 함께 사용할 구독을 활성화하고 구독 서비스 수준에 대한 커밋된 용량 변경을 요청하여 Keystone 구독을 관리합니다. 서비스 수준에 대한 추가 용량을 요청하면 Cloud Volumes ONTAP 시스템에 더 많은 스토리지가 제공됩니다. 
---
= Keystone 구독 관리
:hardbreaks:
:allow-uri-read: 
