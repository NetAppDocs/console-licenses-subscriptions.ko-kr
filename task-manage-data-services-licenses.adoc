...
라이선스와 연결된 NetApp Console 계정이 NetApp Support Site 계정이기도 한 경우 **Licenses and subscriptions** 섹션에 라이선스 정보가 자동으로 표시됩니다. NSS 계정과 연결되지 않은 Console 계정을 사용한 경우에는 라이선스를 수동으로 추가해야 합니다.
