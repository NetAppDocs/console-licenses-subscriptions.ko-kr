...
summary: 'NetApp 데이터 서비스에서 사용하기 위해 NetApp에서 직접 구매한 라이센스(BYOL)를 관리합니다. 사용된 라이센스 용량, 용량 사용량 및 곧 만료될 라이센스를 확인할 수 있습니다.' 
---
...
[role="lead"]
NetApp에서 직접 구매한 라이선스(BYOL)를 관리하여 Cloud Volumes ONTAP를 포함한 NetApp 데이터 서비스에 사용할 수 있습니다. 사용 중인 라이선스 용량, 용량 사용량 및 만료 예정일을 확인할 수 있습니다.
...
* https://docs.netapp.com/us-en/data-services-backup-recovery/br-start-licensing.html["NetApp Backup and Recovery 에 대한 라이선싱 설정"^]
* https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-licensing.html["NetApp Disaster Recovery 에 대한 라이선싱 설정"^]
* https://docs.netapp.com/us-en/data-services-ransomware-resilience/rp-start-licenses.html["NetApp Ransomware Resilience 에 대한 라이선싱 설정"^]
* https://docs.netapp.com/us-en/data-services-cloud-tiering/task-licensing-cloud-tiering.html["NetApp Cloud Tiering 에 대한 라이선싱 설정"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Cloud Volumes ONTAP 에 대한 라이선싱 설정"^]
...
. 콘솔 계정 ID 찾기:
+
.. Console의 탐색 메뉴에서 *Administration* > *Identity and access*를 선택합니다.
...
라이선스와 연결된 NetApp Console 계정이 NetApp Support Site 계정이기도 하고 인터넷에 접속할 수 있는 경우, 라이선스 정보는 **Licenses and subscriptions** 섹션에 자동으로 표시됩니다. NSS 계정과 연결되지 않은 Console 계정을 사용한 경우에는 라이선스를 수동으로 추가해야 합니다.
...
. 서비스 이름 행을 선택하여 확장합니다. 해당 서비스와 관련된 모든 라이센스가 표시됩니다. 확장된 각 행에는 라이센스 ID, 일련 번호, 용량 및 만료 날짜를 포함한 라이센스에 대한 자세한 정보가 표시됩니다.
