...
---
= Cloud Volumes ONTAP의 용량 기반 라이선싱 관리
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
에센셜 패키지에 표시되는 용량을 더 잘 이해하려면 충전 방식에 대해 알아두는 것이 좋습니다. https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-licensing.html#notes-about-charging["Essentials 패키지 요금 청구에 대해 알아보세요"^].
...
| 총 사전 약속 용량 | BYOL 라이선스 및 Marketplace 계약을 포함하여 NetApp에서 구매한 총 라이선스 용량입니다. 이 값은 총 BYOL 용량과 총 마켓플레이스 계약 용량의 합계입니다. 
