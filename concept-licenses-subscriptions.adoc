...
[role="lead"]
NetApp NetApp Console 에서 NetApp (BYOL), NetApp 데이터 서비스( Cloud Volumes ONTAP 포함)에 대한 마켓플레이스 구독, NetApp Keystone 구독에서 구매한 라이선스를 관리하고 모니터링할 수 있습니다.
...
* https://docs.netapp.com/us-en/data-services-backup-recovery/index.html["백업 및 복구"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/index.html["Cloud Volumes ONTAP"^]
* https://docs.netapp.com/us-en/data-services-disaster-recovery/index.html["재해 복구"^] (BYOL만 해당)
* https://docs.netapp.com/us-en/data-services-ransomware-resilience/index.html["랜섬웨어 복원력"^]
* https://docs.netapp.com/us-en/data-services-cloud-tiering/index.html["클라우드 티어링"^]
